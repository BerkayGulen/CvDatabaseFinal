...
public class PanelEdit extends javax.swing.JPanel {
    ...
    public PanelEdit(CvOwner currentPerson) {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(6, 6, 6)
                .addComponent(pnlNavBar, javax.swing.GroupLayout.DEFAULT_SIZE, 728, Short.MAX_VALUE))
        );
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        try {
            ...
            Logger.getLogger(PanelEdit.class.getName()).log(Level.SEVERE, null, ex);
        }
